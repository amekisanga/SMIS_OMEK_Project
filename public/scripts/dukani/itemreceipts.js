...
// //Get total sales 
// //$scope.sales_total = function(loadsalesreceipt){
// //	console.log(loadsalesreceipt);
// //console.log(loadsalesreceipt[0].quantity_sold_amount);
// //var number = $scope.loadsalesreceipt[1].length;
// //console.log(number);
// //var totalsale = 0;
// //for(var i = 0; i<loadsalesreceipt.length; i++){
// //	console.log(loadsalesreceipt[i].quantity_sold_amount);
// // var totalsales = 2;
